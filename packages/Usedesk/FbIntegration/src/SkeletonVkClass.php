...
namespace Usedesk\FbIntegration;

use Illuminate\Support\Facades\Config;

use Usedesk\FbIntegration\Telegram\TelegramApi;
use Usedesk\FbIntegration\Twitter\TwitterApi;
use Usedesk\FbIntegration\Facebook\FacebookApi;
use Usedesk\Api\Webhooks\MandrillWebhookController;
...
class SkeletonClass
{
    ...
    /**
     * Handle a hard bounced email акщь mandrill webhook
     *
     * @param $payload
     */
